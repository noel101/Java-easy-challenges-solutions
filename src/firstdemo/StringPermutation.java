...
public class StringPermutation {
    ...
    public List<String> permute(char input[]) {
        ...
        permuteUtil(str, count, result, 0, resultList);                     //level=0
        return resultList;
    }
    ...
    public void permuteUtil(char str[], int count[], char result[], int level, List<String> resultList) {
        ...
        for(int i = 0; i < str.length; i++) {
            ...
            result[level] = str[i];    											System.out.print(result[level]+ " ");
            count[i]--;
            permuteUtil(str, count, result, level + 1, resultList);				System.out.print(result[level]+ " ");
